...
def search_recur():
  query = searchvar.get()
  selections = []
  for child in rtree.get_children():
      if query in rtree.item(child)['values']:
          print(rtree.item(child)['values'])
          selections.append(child)
  rtree.selection_set(selections)
#   sear = searchvar.get()
#   for record in rtree.get_children():
#     rtree.delete(record)
#   searchtop.destroy()
...
def view_invoice_recurring():
  ...
  # print(psdata)
    ...
    def customer_invoice_recurring():
      ...
      custree.column("#0", width=35, anchor="center")
      custree.column("1", width=160, anchor="center")
      custree.column("2", width=160, anchor="center")
      custree.column("3", width=140, anchor="center")
      custree.column("4", width=140, anchor="center")
      ...
      # global filttxt 
       ...
       filtr = filttxt.get()
       for record in custree.get_children():
         custree.delete(record)
    ...
    # global filttxt
      ...
      def items_selected(event):
        ...
        if selected_filter == "View all records":
          for record in cusventtreeas.get_children():
            cusventtreeas.delete(record)
          countp = 0
          for i in pandsdatazbn:
            cusventtreeas.insert(parent='', index='end', iid=countp, text='', values=(i[2],i[4],i[7],i[12],i[13]))
          countp += 1
      ...
      btn1=Button(cuselection,compound = LEFT,image=tick,text="Edit selected customer", width=150,command=createrec).place(x=250, y=610)
      btn1=Button(cuselection,compound = LEFT,image=tick, text="Add new customer", width=150,command=createrec).place(x=435, y=610)
    ...
    def newline_recurring():
      ...
      newselection.title("Products/Services")
      ...
      def productrec():  
        ...
        okButton = Button(innerFrame,compound = LEFT,image=tick , text ="Ok",command=rec_pro_insert,width=60)
      ...
      global cusventtreeas
      cusventtreeas=ttk.Treeview(newselection, height=27)
      cusventtreeas["columns"]=["1","2","3", "4","5"]
      cusventtreeas.column("#0", width=35, anchor="center")
      cusventtreeas.column("1", width=160, anchor="center")
      cusventtreeas.column("2", width=160, anchor="center")
      cusventtreeas.column("3", width=140, anchor="center")
      cusventtreeas.column("4", width=70, anchor="center")
      cusventtreeas.column("5", width=70, anchor="center")
      cusventtreeas.heading("#0",text="")
      cusventtreeas.heading("1",text="ID/SKU")
      cusventtreeas.heading("2",text="Product/Service Name")
      cusventtreeas.heading("3",text="Unit price")
      cusventtreeas.heading("4",text="Service")
      cusventtreeas.heading("5",text="Stock")
      cusventtreeas.place(x=5, y=45)
      def filtm():
      # global filttxt 
       ...
       for i in records:
         if True:
          cusventtreeas.insert(parent='', index='end', iid=i, text='', values=(i[0],i[4],i[10],i[8]))  
         else:
           pass
       count += 1
    ...
    # global filttxt
      ...
      filttxt.place(x=110, y=10)
      fltrbutton=Button(newselection,text = 'Click Here',command=filtm)
      fltrbutton.place(x=236,y=7,height=25,width=70)
      ...
      global treec
      def selectpro():
          selected = cusventtreeas.focus()
          global valuep10,totalpriceinput
          valuep10= cusventtreeas.item(selected)["values"][0]
          ...
          j = 0
          for i in fbcursor:
            treerec.insert(parent='', index='end', iid=i, text='', values=(i[0],i[4],i[5],i[7],1,i[8],i[10],(i[7]*1)))
            for line in treerec.get_children():
              idsave1=treerec.item(line)['values'][7]
              totalpriceinput+=idsave1
              j += 1
              pricecol.config(text=totalpriceinput)

          valu10= cusventtreeas.item(selected)["values"][0]
          ...
          vatree=(child[0],recurdata[0],child[2],child[3],child[4],child[5],child[6],child[7],child[8],child[9],child[10],child[11],child[12],child[13],child[14],child[15],child[16],1)
          ...
          # avngr=int(1)
          # qntvaladd=(avngr,child[0],recurdata[0])
      ...
      # def selectp2():
      #     selected = cusventtreeas.focus()
      #     valuesp= cusventtreeas.item(selected)["values"][0]
      ...
      j = 0
      for i in fbcursor:
        cusventtreeas.insert(parent='', index='end', iid=i, text=' ', values=(i[0],i[4],i[7],i[12],i[13]))
      j += 1
      ...
      #    countp = 0
      #    for i in pandsdatazbn:
      #      cusventtreeas.insert(parent='', index='end', iid=countp, text='hello', values=('',i[2],i[4],i[7],i[12],i[13]))
      #      countp += 1
      #  elif selected_filter == "View all products":
      #    for record in cusventtreeas.get_children():
      #      cusventtreeas.delete(record)
      #    countp = 0
      #    for i in pdata:
      #      cusventtreeas.insert(parent='', index='end', iid=countp, text='productdata',values=('',i[2],i[4],i[7],i[12],i[13]))
      #      countp += 1
      #  else:
      #    for record in cusventtreeas.get_children():
      #      cusventtreeas.delete(record)
      #    countp = 0
      #    for i in sdata:
      #      cusventtreeas.insert(parent='', index='end', iid=countp, text='servicedata', values=('',i[2],i[4],i[7],i[12],i[13]))
      #      countp += 1
      ...
      btn1=Button(newselection,compound = LEFT,image=tick ,text="ok",command=selectpro,width=60).place(x=15, y=610)
      btn1=Button(newselection,compound = LEFT,image=tick , text="Edit product/Service", width=150,command=productrec).place(x=250, y=610)
      btn1=Button(newselection,compound = LEFT,image=tick , text="Add product/Service", width=150,command=productrec).place(x=435, y=610)
    ...
    def delete_recur_item():
        # selected_item = treerec.selection()[0]
        # print(selected_item)
        # treerec.delete(selected_item)

        itemid = treerec.item(treerec.focus())["values"][0]
        print(itemid,)
        dlting=recurdata[0]
        treerec.delete(treerec.selection()[0])
        ...
        # if messdel == True:
        #  itemidz = treerec.item(treerec.focus())["values"][0]
  ...
  #     fbcursor.execute(sql, val)
  #     fbilldb.commit()
  #     rtree.delete(rtree.selection()[0])
  #   else:
  #     pass  
...
######################################## UPDATING RECURRING##############################################
  def updateinvorec():
    ...
    ctgryy4=cat4.get()
    bc4="Draft"
    idorder4= recurdata[0]


    for line in treerec.get_children():
      idsave=treerec.item(line)['values'][0]
      ...
      sql3='UPDATE Invoice SET invoiceid=%s,invodate=%s,duedate=%s,businessname=%s,status=%s,extracostname=%s,extracost=%s,template=%s,salesper=%s,discourate=%s,tax1=%s,category=%s,businessaddress=%s,shipname=%s,shipaddress=%s,cpemail=%s,cpmobileforsms=%s WHERE invoiceid=%s'
      val2= invid4,orddatein4,ordduein4,cmbodto4,bc4,extracstnme4,extracst4,tplts4,slzprzn4,discountrte4,taax4,ctgryy4,addrsfrm4,sptto4,adrsto4,emlfrm4,smsfrm4,idorder4
      ...
      # countp = 0
      # for i in pandsdata:
      #   rtree.insert(parent='', index='end', iid=i, text='', values=('',i[0], i[26], i[24], i[27], i[18], i[8]))
      # countp += 1
      ...
      # countp = 0
      # for i in pandsdata:
      #   rtree.insert(parent='', index='end', iid=i, text='', values=('',i[0], i[26], i[24], i[27], i[18], i[8], i[7], i[13], i[14], i[11],i[16],i[3]))
        
      #   #values=('',i[0], i[26], i[24], i[27], i[18], i[8]))
      # countp += 1
      # messagebox.showinfo('Successfully Updated','Successfully Updated')
      ...
      for i in pandsdata:
        if True:
           rtree.insert(parent='', index='end', iid=i, text='hello', values=('',i[0], i[26], i[24], i[27], i[18], i[8]))
        else:
          pass
      count += 1
      pop.destroy()
  ...
  add= Button(firFrame,compound="top", text="Add new\nline item",relief=RAISED, image=photo,bg="#f5f3f2", fg="black", height=55, bd=1, width=55,command=newline_recurring)
  add.pack(side="left", pady=3, ipadx=4)

  dele= Button(firFrame,compound="top", text="Delete line\nitem",relief=RAISED, image=photo2,bg="#f5f3f2", fg="black", height=55, bd=1, width=55,command=delete_recur_item)
  ...
  Createorder= Button(firFrame,compound="top", text="Save\nChanges",relief=RAISED, image=tick,bg="#f5f3f2", fg="black", height=55, bd=1, width=55,command=updateinvorec)
...
#----------------------------------------------------------------------
  ...
  # #----------------------Recurring Functions-----------------------------------------------  
  global recurentry1, recurentry2,checkvarStatus6,period2, current_var, month_var,stopcheck,btn,checkvarStatus7
  def isChecked():
...
##
  ...
  ordercombo = ttk.Combobox(labelframe1, value=pdata,width=28)
  ...
  sctxt = scrolledtext.Text(labelframe1,width=23)
  ...
  addi=scrolledtext.Text(labelframe1,width=23)
  ...
  global treerec
  treerec=ttk.Treeview(listFrame, show = "headings")
  treerec.pack(side = 'top')
  treerec["columns"]=["1","2","3","4","5","6","7","8"]
  treerec.column("#0", width=40, anchor="center")
  treerec.column("1", width=80, anchor="center")
  treerec.column("2", width=190, anchor="center")
  treerec.column("3", width=190, anchor="center")
  treerec.column("4", width=80, anchor="center")
  treerec.column("5", width=60, anchor="center")
  treerec.column("6", width=60, anchor="center")
  treerec.column("7", width=60, anchor="center")
  treerec.column("8", width=80, anchor="center")
 
  treerec.heading("#0")
  treerec.heading("1",text="ID/SKU")
  treerec.heading("2",text="Product/Service")
  treerec.heading("3",text="Description")
  treerec.heading("4",text="Unit Price")
  treerec.heading("5",text="Quantity")
  treerec.heading("6",text="Pcs/Weight")
  treerec.heading("7",text="Tax1")
  treerec.heading("8",text="Price")
  ...
  j = 0
  for i in fbcursor:
    treerec.insert(parent='', index='end', iid=i, text='', values=(i[21],i[6],i[7],i[9],i[22],i[10],i[12],(i[9]*i[22])))
    # for line in treerec.get_children():
    #   idsave1=treerec.item(line)['values'][7]
  ...
  treerec.pack(fill="both", expand=1)
  ...
  def edit_window_box_rec(val):
    ...
    def value_assignment_rec(event):
        ...
        selected0 = treerec.focus()
        valuz1= treerec.item(selected0)["values"]
        ...
        val0z1=(valuz1[0],valuz1[1],valuz1[2],valuz1[3],valuz1[4],valuz1[5],valuz1[6],recurdata[0],idgettingprdt)
        # dnz=(ordrid,sql2z0,)
        print(val0z1)
        ...
        if bolo==recurdata[0]:        
         for record in treerec.get_children():
          treerec.delete(record)
         ...
         for i in panrefrdata:
           treerec.insert(parent='', index='end', iid=i, text='', values=(i[4],i[6],i[7],i[9],i[22],i[10],i[12],(i[9]*i[22])))
    ...
    edit_window.bind('<Return>', value_assignment_rec )
    


    B1 = tk.Button(edit_window, text=" Okay ")
    B1.bind('<Button-1>',value_assignment_rec)
    B1.place(x=70,y=130)
  ...
  def tree_click_handler(event):
      cur_item = treerec.item(treerec.focus())
      # print(cur_item)
      global indexcol
      indexcol = treerec.identify_column(event.x)[1:]
      rowid = treerec.identify_row(event.y)[1:]
      # print(indexcol)
      # print(rowid)
      #updates list
      shape1.set(indexcol)
      try:
          x,y,w,h = treerec.bbox('I'+rowid,'#'+indexcol)
      except:pass
      #tree.tag_configure("highlight", background="yellow")
      return(indexcol)

  #code linked to event    
  treerec.bind('<ButtonRelease-1>', tree_click_handler)

  #edit a value in a clicked cell
  def edit(event):
      try:
          selected_item = treerec.selection()[0]
          temp = list(treerec.item(selected_item , 'values'))
          tree_click_handler
          col_selected = int(shape1.get())-1
          edit_window_box_rec(temp[col_selected])
...
##
  ...
  disr.delete(0,'end')
  disr.insert(0, orbtdata[13])

  
  extra=IntVar()
  cost2=Label(labelframe1,text="Extra cost").place(x=35,y=35)
  extrac=Entry(labelframe1,width=10,textvariable=extra)
  extrac.place(x=115,y=35)
  extrac.delete(0,'end')
  extrac.insert(0, orbtdata[10])
...
##
  ...
  tem4=ttk.Combobox(labelframe1, value=tmpltdata,width=25)
  tem4.place(x=115,y=70)
  tem4.delete(0,'end')
  tem4.insert(0, orbtdata[11])
...
##
  ...
  cusventtreeas1=ttk.Treeview(payementFrame, height=5)
  cusventtreeas1["columns"]=["1","2","3","4","5"]
  cusventtreeas1.column("#0", width=20, anchor="center")
  cusventtreeas1.column("1", width=140, anchor="center")
  cusventtreeas1.column("2", width=140, anchor="center")
  cusventtreeas1.column("3", width=110, anchor="center")
  cusventtreeas1.column("4", width=140, anchor="center")
  cusventtreeas1.column("5", width=110, anchor="center")
  cusventtreeas1.heading("#0",text="", anchor=W)
  cusventtreeas1.heading("1",text="Payment ID")
  cusventtreeas1.heading("2",text="Payment date")
  cusventtreeas1.heading("3",text="Paid by")
  cusventtreeas1.heading("4",text="Description")
  cusventtreeas1.heading("5",text="Amount")      
  cusventtreeas1.place(x=50, y=45)
...
#   if convert == True:
#     convertid = rtree.item(rtree.focus())["values"][1]
#     # print (convertid)
#     # sql = 'INSERT INTO invoice WHERE invoiceid=%s'
    
#     # for line in rtree.get_children():
#     # idsave1 = rtree.item(rtree.focus())["values"][1]
...
#     j = 0
#     for i in fbcursor:
#      rtree.insert(parent='', index='end', iid=i, text='', values=(' ',i[0], i[1], i[2], i[3], i[4],i[5], i[6], i[7], i[8], i[9], i[10]))
#     j += 1
...
mainFrameas=Frame(tab4, relief=GROOVE, bg="#f8f8f2")
mainFrameas.pack(side="top", fill=BOTH)

midFrame=Frame(mainFrameas, bg="#f5f3f2", height=60)
...
previewLabel = Button(midFrame,compound="top", text="Print Selected",relief=RAISED, image=photo4,bg="#f8f8f2", fg="black", height=55, bd=1, width=75,command=printpreviewinvoice_recurring)
...
productLabel = Button(midFrame,compound="top", text="Hide totals\nSUM",relief=RAISED, image=photo9,bg="#f8f8f2", fg="black", height=55, bd=1, width=75)
productLabel.pack(side="left")

# productLabel = Button(midFrame,compound="top", text="Hide totals\nSUM",relief=RAISED, image=photo9,bg="#f8f8f2", fg="black", height=55, bd=1, width=75,command=lambda: label.place_forget())
# productLabel.pack(side="left")

# label = Label(midFrame, text = "$500")
# label.place(x=1253 ,y=60)


invoilabel = Label(mainFrameas, text="Recurring invoices", font=("arial", 18), bg="#f8f8f2")
...
recsaving = Label(mainFrameas,bg="#f5f3f2")
recsaving.place(x= 100 , y = 120)
...
def mainprorec(event):

        selected = rtree.focus()
        selected_prdct= rtree.item(selected)["values"][1]
        ...
        j = 0
        for i in prdctsltn:
          treec.insert(parent='', index='end', iid=i, text='', values=(' ',i[21], i[6], i[7],i[9],i[22],i[12],(i[9]*i[22])))
        j += 1
rtree.bind('<Double-Button-1>' , mainprorec)
...
tab1as = ttk.Frame(tabControl)
tab2as = ttk.Frame(tabControl)
tab3as=  ttk.Frame(tabControl)
tab4as = ttk.Frame(tabControl)
tabControl.add(tab1as,image=invoices,compound = LEFT, text ='Invoice Items')
tabControl.add(tab2as,image=photo11,compound = LEFT, text ='Invoice Private Notes')
tabControl.add(tab3as,image=smslog,compound = LEFT, text ='SMS log')
tabControl.add(tab4as,image=photo11,compound = LEFT, text ='Documents')
tabControl.pack(expand = 1, fill ="both")
    
  
treec = ttk.Treeview(tab1as, columns = (1,2,3,4,5,6,7,8,), height = 15, show = "headings")
treec.pack(side = 'top')
treec.heading(1)
treec.heading(2, text="Product/Service ID",)
treec.heading(3, text="Name")
treec.heading(4, text="Description")
treec.heading(5, text="Price")
treec.heading(6, text="QTY")
treec.heading(7, text="Tax1")
treec.heading(8, text="Line Total")   
treec.column(1, width = 40, anchor="center")
treec.column(2, width = 250, anchor="center")
treec.column(3, width = 270, anchor="center")
treec.column(4, width = 300, anchor="center")
treec.column(5, width = 130, anchor="center")
treec.column(6, width = 100, anchor="center")
treec.column(7, width = 100, anchor="center")
treec.column(8, width = 190, anchor="center")




note1=Text(tab2as, width=170,height=10).place(x=10, y=10)

note1=Text(tab3as, width=170,height=10).place(x=10, y=10)

tree = ttk.Treeview(tab4as, columns = (1,2,3), height = 15, show = "headings")
tree.pack(side = 'top')
tree.heading(1)
...
scrollbar = Scrollbar()
scrollbar.place(x=992+350,y=519,height=205)
...
################################################ CREATE INVOICE #############################################
  def createinvoice():
    ...
    # itemid1 = tree07.item(tree07.get_children())["values"][1]
    # print(itemid1)


    # for line in tree07.get_children():
    #   idsave=tree07.item(line)['values'][0]
    #   sql1= 'SELECT * FROM  Productservice WHERE Productserviceid = %s'
    #   val=(idsave,)
    #   print(val)
    #   fbcursor.execute(sql1,val,)
    #   child=fbcursor.fetchone()
    #   print(child)
    #   sql2= 'INSERT INTO storingproduct(Productserviceid,invoiceid,sku,category,name,description,status,unitprice,peices,cost,taxable,priceminuscost,serviceornot,stock,stocklimit,warehouse,privatenote) VALUES(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)'
    #   val1=(child[0],ordrid,child[1],child[2],child[3],child[4],child[5],child[6],child[7],child[8],child[9],child[10],child[11],child[12],child[13],child[14],child[15])
    #   fbcursor.execute(sql2,val1,)
    #   fbilldb.commit()
    
    # sql3='INSERT INTO Invoice (invoiceid, invodate, duedate, businessname, status, extracostname, extracost, template, salesper, discourate, tax1, category, businessaddress, shipname, shipaddress, cpemail, cpmobileforsms, recurring_period, recurring_period_month, next_invoice, stop_recurring) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)'
    # val2=(ordrid,orddatein,ordduein,cmbodto,ab,extracstnme,extracst,tplts,slzprzn,discountrte,taax,ctgryy,addrsfrm,sptto,adrsto,emlfrm,smsfrm,recurring_period,recurring_period_month,next_invoice,stop_invoice)
    # fbcursor.execute(sql3,val2,)
    # fbilldb.commit()

    sql3='UPDATE invoice SET  invodate=%s, duedate=%s, businessname=%s, status=%s, extracostname=%s, extracost=%s, template=%s, salesper=%s, discourate=%s, tax1=%s, category=%s, businessaddress=%s, shipname=%s, shipaddress=%s, cpemail=%s, cpmobileforsms=%s,	orderid=%s, recurring_period=%s, recurring_period_month=%s, next_invoice=%s, stop_recurring=%s WHERE invoiceid=%s' 
    val2=(orddatein,ordduein,cmbodto,ab,extracstnme,extracst,tplts,slzprzn,discountrte,taax,ctgryy,addrsfrm,sptto,adrsto,emlfrm,smsfrm, ordrefer,recurring_period,recurring_period_month,next_invoice,stop_invoice,invodata)
    fbcursor.execute(sql3,val2,)
    fbilldb.commit()
 ...
 ##
  ...
  pricecal1 = Label(listFrame,bg="#f5f3f2")
  pricecal1.place(x=850,y=200,width=78,height=18)
...
##
  ...
  priceco0 = Label(listFrame,bg="#f5f3f2").place(x=850,y=200,width=78,height=18)
  ...
  def edit_window_box(val):
    ...
    def value_assignment(event):
        ...
        sql2z0= 'UPDATE storingproduct SET sku=%s,name=%s,description=%s,unitprice=%s,stock=%s,peices=%s,taxable=%s WHERE invoice=%s AND Productserviceid=%s'
        ...
        fbcursor.execute("SELECT * FROM storingproduct ORDER BY invoiecid DESC LIMIT 1")
        bolo = fbcursor.fetchone()[0]
        print(bolo)
        print(osdata[0])
...
expenseLabel = Button(midFrame,compound="top", text="E-mail\nInvoice",relief=RAISED, image=photo6,bg="#f8f8f2", fg="black", height=55, bd=1, width=55,command=email_invoice_recurring)
expenseLabel.pack(side="left")
